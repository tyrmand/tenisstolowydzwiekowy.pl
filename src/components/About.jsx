                    ...
                    <div>
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h5 class="card-subtitle mb-2 text-muted">Tenis Stołowy Dźwiękowy</h5>
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h5 class="card-subtitle mb-2 text-muted">Jaki sprzęt do tenisa stołowego dźwiękowego?</h5>
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h5 class="card-subtitle mb-2 text-muted">W tenisie stołowym dźwiękowym rozgrywa się zawody indywidualne, deblowe i drużynowe</h5>
                                <div class="card-header">
                                    <strong>Zawody indywidualne</strong>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"> W zawodach indywidualnych gra się do 5 lub do 15 punktów</li>
                                    <li class="list-group-item">Gra ta polega na podawaniu piłeczki za pomocą rąk, w taki sposób, aby ta odbiła się minimum dwukrotnie na polu podającego i nie została złapana przez przeciwnika</li>
                                    <li class="list-group-item">Zawodnik rzuca piłeczkę w taki sposób, aby odbiła się ona najpierw na polu podającego (minimum dwukrotnie), a następnie odbijała się na polu przeciwnika</li>
                                    <li class="list-group-item">Prawidłowa obrona to taka, gdy zawodnik łapiący piłkę nie dotknie łokciami powierzchni stołu i nie pomoże sobie w czasie łapania tułowiem, klatką piersiową, głową, nogami</li>
                                </ul>
                                <div class="card-header">
                                    <strong>Zawody deblowe, mikst</strong>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">W zawodach deblowych i w mikście uczestniczą dwa zespoły, po dwóch zawodników w każdym. Gra się do 5 lub do 15 punktów</li>
                                    <li class="list-group-item">W mikście rywalizują dwuosobowe zespoły, złożone z kobiety i mężczyzny</li>
                                </ul>
                                <div class="card-header">
                                    <strong>Zawody drużynowe</strong>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">3-osobowe drużyny grają systemem sztafetowym, tzn.: kolejna para grających przejmuje wyniki pary poprzedniej</li>
                                    <li class="list-group-item">Kolejne pojedynki następują co 5 punktów, do uzyskania przez jeden z zespołów 45 punktów</li>
                                </ul>
                            </div>
                        </div>
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h5 class="card-subtitle mb-2 text-muted">Kiedy zostaje przyznany punkt?</h5>
                                <div class="card-header">
